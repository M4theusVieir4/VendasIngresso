...
app.post('/partners/register', async (req, res) => {
    ...
    try{
        ...
        const [parnerResult] = await connection.execute<mysql.ResultSetHeader>(
            "INSERT INTO partners (user_id, company_name, created_at) VALUES( ?, ?, ?)",
            [userId, company_name, createdAt]
        );
        res
            .status(201)
            .json({id: parnerResult.insertId, name, user_id: userId, company_name, created_at: createdAt});
...
app.post('/customers/register', async (req, res) => {
    ...
    try{
        ...
        res
            .status(201)
            .json({id: parnerResult.insertId, name, user_id: userId, address, phone, created_at: createdAt});
